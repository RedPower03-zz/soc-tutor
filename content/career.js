...
export const RANKS = [
  ...
  { id: 'hunter', title: 'Threat Hunter', band: 'l3', xp: 48000, gates: [{ type: 'skills', skills: ['l2-hunting', 'l3-identity'] }] },
  { id: 'detection', title: 'Detection Engineer', band: 'l3', xp: 58000, gates: [{ type: 'skills', skills: ['l2-siem', 'l3-detection'] }] },
  { id: 'lead', title: 'SOC Lead', band: 'l3', xp: 70000, gates: [{ type: 'tier', tier: 'l3' }] },
  { id: 'manager', title: 'SOC Manager', band: 'l3', xp: 85000, gates: [{ type: 'all-tiers' }, { type: 'scenario', id: 'major-incident', title: 'Major incident capstone' }] },
];
