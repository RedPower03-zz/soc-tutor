...
const items = [
  {
    ...
    choices: [
      ...
      'The system disk (a full image)',
      'Remote syslog server data',
      'Archived backup tapes',
    ],
    answer: 'CPU registers, cache and RAM',
    misconceptions: {
      'The system disk (a full image)': 'for-volatility-order',
    },
    explanation:
  ...
  },
  {
    ...
    choices: [
      'Everything in memory: processes, connections, keys',
      'Nothing: a clean shutdown preserves everything that matters',
      'Only the desktop wallpaper and the user\'s open windows',
      'The event logs are deleted',
    ],
    answer: 'Everything in memory: processes, connections, keys',
    misconceptions: {
      'Nothing: a clean shutdown preserves everything that matters': 'for-shutdown-preserves',
    },
    explanation:
  ...
  },
  {
    ...
    difficulty: 2,
    type: 'mc',
    prompt: 'You find `C:\\Windows\\Prefetch\\RCLONE.EXE-9A3B1C2D.pf` on finance workstation WS-FIN-07 (Windows 11). What does it establish?',
    snippet:
      'PECmd.exe -f RCLONE.EXE-9A3B1C2D.pf\n  Executable name: RCLONE.EXE\n  Run count: 3\n  Last run: 2026-09-24 02:58:41 UTC\n  Other run times: 2026-09-24 02:55:12, 2026-09-24 02:54:03\n  Directories referenced: \\VOLUME{...}\\USERS\\PUBLIC\\MUSIC\\, \\VOLUME{...}\\USERS\\M.OSEI\\DOCUMENTS\\FINANCE-EXPORT\\',
    choices: [
      'rclone.exe ran three times, last at 02:58:41 UTC',
      'It proves the finance data was uploaded to the internet',
      'It only shows the file was downloaded, not that it ran',
      'Prefetch lists every file on disk',
    ],
    answer: 'rclone.exe ran three times, last at 02:58:41 UTC',
    misconceptions: {
      'It proves the finance data was uploaded to the internet': 'for-prefetch-meaning',
      'It only shows the file was downloaded, not that it ran': 'for-prefetch-meaning',
      'Prefetch lists every file on disk': 'for-prefetch-meaning',
    },
    explanation:
      'Prefetch is an **execution** artifact: the program ran, when and how often, and what it touched at start-up. It does not prove what data left; for that, correlate with firewall/proxy byte counts, SRUM network usage and rclone config files. rclone in a Music folder at 03:00 is a well-known exfiltration pattern. Note: Prefetch is on by default on Windows client versions but **off by default on Windows Server**, so on servers you usually lean on Amcache, ShimCache, 4688/Sysmon and EDR instead, and a missing .pf file there proves nothing.',
  },
  {
    id: 'for-05',
    skill: 'l3-forensics',
    ...
    choices: [
      'No change to the original; the hashes prove an exact copy',
      'The write blocker makes the copy much faster to finish',
      'SHA-256 encrypts the evidence so nobody can tamper with it',
      'So that the finished image can be opened in a normal viewer',
    ],
    answer: 'No change to the original; the hashes prove an exact copy',
    misconceptions: {
      'SHA-256 encrypts the evidence so nobody can tamper with it': 'for-copy-is-image',
    },
    explanation:
  ...
  },
  {
    ...
    choices: [
      'Deleted files, slack, unallocated space and metadata',
      'Nothing: a copy of the folder is the same as a disk image',
      'Only the file icons and the folder view settings',
      'The copy has to be zipped and password-protected to count',
    ],
    answer: 'Deleted files, slack, unallocated space and metadata',
    misconceptions: {
      'Nothing: a copy of the folder is the same as a disk image': 'for-copy-is-image',
      'The copy has to be zipped and password-protected to count': 'for-copy-is-image',
    },
    explanation:
  ...
  },
  {
    ...
    choices: [
      'Timestomping: $SI backdated; $FN shows 23 Sep 2026',
      'The file is a genuine Windows system file installed in 2019',
      'The computer\'s clock was wrong back in December 2019',
      'Nothing: the two attributes always differ by several years',
    ],
    answer: 'Timestomping: $SI backdated; $FN shows 23 Sep 2026',
    misconceptions: {
      'The file is a genuine Windows system file installed in 2019': 'for-prefetch-meaning',
    },
    explanation:
  ...
  },
  {
    ...
    choices: [
      'Likely injected or hollowed code, which memory analysis reveals',
      'Nothing: rundll32 routinely connects to the internet on its own',
      'It proves the disk is encrypted, so memory is the only source',
      'Memory images cannot show network connections, so it\'s an error',
    ],
    answer: 'Likely injected or hollowed code, which memory analysis reveals',
    misconceptions: {
      'Memory images cannot show network connections, so it\'s an error': 'for-volatility-order',
    },
    explanation:
  ...
  },
  {
    ...
    choices: [
      'To tell responder actions from the attacker\'s later',
      'To bill the customer for the hours',
      'Because the operating system requires a log of every login',
      'It is not needed, because the event logs record everything',
    ],
    answer: 'To tell responder actions from the attacker\'s later',
    misconceptions: {
      'It is not needed, because the event logs record everything': 'for-copy-is-image',
    },
    explanation:
  ...
  },
  {
    ...
    choices: [
      'Isolate with EDR, suspend it, then capture memory',
      'Pull the plug: powering off preserves everything as it is',
      'Do a clean shutdown so the disk is consistent for imaging',
      'Leave it running and connected so the encryption finishes',
    ],
    answer: 'Isolate with EDR, suspend it, then capture memory',
    misconceptions: {
      'Pull the plug: powering off preserves everything as it is': 'for-shutdown-preserves',
