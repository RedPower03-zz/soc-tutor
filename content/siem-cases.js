...
export const SIEM_CASES = [
  // ------------------------------------------------------------------ 1
  {
    ...
    logs: [
      ...
      { id: 'b03', t: '03:02:04', src: 'winevt', host: 'SRV-FILE01', user: 'administrator', type: 'Security 4625', msg: 'An account failed to log on. Account: administrator  Logon Type: 10  Source: 203.0.113.45  Failure: unknown user name or bad password' },
      { id: 'b04', t: '03:03:41', src: 'winevt', host: 'SRV-FILE01', user: 'administrator', type: 'Security 4625', msg: 'An account failed to log on. Account: administrator  Logon Type: 10  Source: 203.0.113.45' },
      ...
      { id: 'b06', t: '03:05:19', src: 'winevt', host: 'SRV-FILE01', user: 'administrator', type: 'Security 4625', msg: 'An account failed to log on. Account: administrator  Logon Type: 10  Source: 203.0.113.45' },
      { id: 'b07', t: '03:07:30', src: 'winevt', host: 'SRV-FILE01', user: 'administrator', type: 'Security 4625', msg: 'An account failed to log on. Account: administrator  Logon Type: 10  Source: 203.0.113.45' },
      { id: 'b08', t: '03:08:12', src: 'dns', host: 'WS-04', user: '', type: 'Query A', msg: 'WS-04 (10.10.40.14) query A update.example.com -> 192.0.2.80' },
      { id: 'b09', t: '03:09:44', src: 'winevt', host: 'SRV-FILE01', user: 'administrator', type: 'Security 4625', msg: 'An account failed to log on. Account: administrator  Logon Type: 10  Source: 203.0.113.45' },
      { id: 'b10', t: '03:11:05', src: 'winevt', host: 'SRV-FILE01', user: 'administrator', type: 'Security 4625', msg: 'An account failed to log on. Account: administrator  Logon Type: 10  Source: 203.0.113.45' },
      { id: 'b11', t: '03:12:38', src: 'winevt', host: 'SRV-FILE01', user: 'administrator', type: 'Security 4625', msg: 'An account failed to log on. Account: administrator  Logon Type: 10  Source: 203.0.113.45' },
      { id: 'b12', t: '03:14:10', src: 'winevt', host: 'SRV-FILE01', user: 'administrator', type: 'Security 4625', msg: 'An account failed to log on. Account: administrator  Logon Type: 10  Source: 203.0.113.45' },
    ...
    key: [
      { id: 'k-fail', label: 'Repeated 4625 RDP failures from 203.0.113.45', rows: ['b03', 'b04', 'b06', 'b07', 'b09', 'b10', 'b11', 'b12'], why: 'Eight failed Logon Type 10 (RDP) attempts for one account from one external IP in about 12 minutes is a password-guessing pattern.' },
      { id: 'k-success', label: '4624 success from the same IP', rows: ['b13'], why: 'The success comes from the same external IP straight after the failures: the guessing worked.' },
    ...
    writeup: [
      ...
      { label: 'Mentions the successful logon', any: ['4624', 'success', 'logged on'] },
    ...
    strong: [
      ...
      'Logon Type 10 means RemoteInteractive (RDP). Combined with the firewall ALLOW to 3389 from the internet, the entry point is clear.',
